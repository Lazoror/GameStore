...
namespace GameStore.DAL.Migrations
{
    ...
    [Migration("20191021093201_DatabaseLangFixEntity")]
    partial class DatabaseLangFixEntity
    {
            ...
            modelBuilder.Entity("GameStore.Domain.Models.LanguageModels.Language", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("49bada3c-a5fe-4cd0-acad-ca2ca5cd89c8"),
                            Code = "en",
                            Name = "English"
                        },
                        new
                        {
                            Id = new Guid("96876f1d-535c-4d72-97cb-54c405af1852"),
                            Code = "ru",
                            Name = "Russian"
                        });
                });
