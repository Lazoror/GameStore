...
namespace GameStore.DAL.Migrations
{
    ...
    [Migration("20191010095551_AddedGenreAndGameLangEntities")]
    partial class AddedGenreAndGameLangEntities
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameStore.Models.Models.Language", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2cb78d39-26f3-4516-9061-95e88b2928b6"),
                            Code = "en",
                            Name = "English"
                        },
                        new
                        {
                            Id = new Guid("52c7a79c-53dd-4c4d-a608-78e7fa52a1a8"),
                            Code = "ru",
                            Name = "Russian"
                        });
                });

            modelBuilder.Entity("GameStore.Models.Models.LanguageModels.GameLang", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("GameStore.Models.Models.LanguageModels.GenreLang", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("GameStore.Models.Models.LanguageModels.PlatformTypeLang", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("GameStore.Models.Models.LanguageModels.GameLang", b =>
                {
                    b.HasOne("GameStore.Models.Models.Game")
                        .WithMany("Languages")
                        .HasForeignKey("GameId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("GameStore.Models.Models.LanguageModels.GenreLang", b =>
                {
                    b.HasOne("GameStore.Models.Models.Genre")
                        .WithMany("Languages")
                        .HasForeignKey("GenreId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("GameStore.Models.Models.LanguageModels.PlatformTypeLang", b =>
                {
                    b.HasOne("GameStore.Models.Models.PlatformType")
                        .WithMany("Languages")
                        .HasForeignKey("PlatformTypeId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("GameStore.Models.Models.LanguageModels.PublisherLang", b =>
                {
                    b.HasOne("GameStore.Models.Models.Publisher")
                        .WithMany("Languages")
                        .HasForeignKey("PublisherId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
