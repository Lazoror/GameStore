...
namespace GameStore.DAL.Migrations
{
    ...
    [Migration("20191017135817_PlatformTypeLangRenamedToPlatformTranslation")]
    partial class PlatformTypeLangRenamedToPlatformTranslation
    {
            ...
            modelBuilder.Entity("GameStore.Domain.Models.LanguageModels.Language", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b847fa49-938a-4974-b257-bd625733a254"),
                            Code = "en",
                            Name = "English"
                        },
                        new
                        {
                            Id = new Guid("50f6512b-5264-4d78-ad5c-e93a3932f790"),
                            Code = "ru",
                            Name = "Russian"
                        });
                });
