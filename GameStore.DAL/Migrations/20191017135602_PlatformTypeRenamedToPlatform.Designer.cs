...
namespace GameStore.DAL.Migrations
{
    ...
    [Migration("20191017135602_PlatformTypeRenamedToPlatform")]
    partial class PlatformTypeRenamedToPlatform
    {
            ...
            modelBuilder.Entity("GameStore.Domain.Models.LanguageModels.Language", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d9bab77b-c3e0-4f8d-965a-80bdc5c10a85"),
                            Code = "en",
                            Name = "English"
                        },
                        new
                        {
                            Id = new Guid("bb705c7b-4c22-4dd7-9ec6-550358d5160f"),
                            Code = "ru",
                            Name = "Russian"
                        });
                });
