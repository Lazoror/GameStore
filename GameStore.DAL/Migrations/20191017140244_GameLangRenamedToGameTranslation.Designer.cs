...
namespace GameStore.DAL.Migrations
{
    ...
    [Migration("20191017140244_GameLangRenamedToGameTranslation")]
    partial class GameLangRenamedToGameTranslation
    {
            ...
            modelBuilder.Entity("GameStore.Domain.Models.LanguageModels.Language", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("54b44948-3638-45c0-840b-4abd991c2606"),
                            Code = "en",
                            Name = "English"
                        },
                        new
                        {
                            Id = new Guid("2cbd46ca-22c8-4335-93cb-cd74726841cb"),
                            Code = "ru",
                            Name = "Russian"
                        });
                });
