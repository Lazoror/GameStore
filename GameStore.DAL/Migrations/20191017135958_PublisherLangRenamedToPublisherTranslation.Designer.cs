...
namespace GameStore.DAL.Migrations
{
    ...
    [Migration("20191017135958_PublisherLangRenamedToPublisherTranslation")]
    partial class PublisherLangRenamedToPublisherTranslation
    {
            ...
            modelBuilder.Entity("GameStore.Domain.Models.LanguageModels.Language", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5f0222ec-0e3a-4fb2-8da4-cc12a4414a1a"),
                            Code = "en",
                            Name = "English"
                        },
                        new
                        {
                            Id = new Guid("b7bfc9bb-507e-456e-baf9-1b31d3538c7d"),
                            Code = "ru",
                            Name = "Russian"
                        });
                });
