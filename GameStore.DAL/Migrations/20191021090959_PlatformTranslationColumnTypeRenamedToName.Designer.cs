...
namespace GameStore.DAL.Migrations
{
    ...
    [Migration("20191021090959_PlatformTranslationColumnTypeRenamedToName")]
    partial class PlatformTranslationColumnTypeRenamedToName
    {
            ...
            modelBuilder.Entity("GameStore.Domain.Models.LanguageModels.Language", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("06831c22-60de-45c2-996f-36d493f921d8"),
                            Code = "en",
                            Name = "English"
                        },
                        new
                        {
                            Id = new Guid("191694ec-5530-492d-b010-3761d3f08fd9"),
                            Code = "ru",
                            Name = "Russian"
                        });
                });
